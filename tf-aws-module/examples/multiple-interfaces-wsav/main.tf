...
locals {
  ...
  # load Balancer
  create_lb                = false
  create_load_balancer_eip = false
}
...
module "wsav" {
  ...
  **********************************************/
  ...
  /*********************************************
  * Provide one of the following -
  * 1. default interface - subnet_id, sg_data_mgmt
  ...
  **********************************************/
  ...
  sg_data_mgmt                = [module.security.sg_data, module.security.sg_mgmt]
  ...
  boot_config = {
    ...
    smart_license_registration_token = "YzkwODM1ZjYtZDgwMi00ZDY1LTg4YjItN2I5MzYxNThiYTg0LTE2MzQyMTMx%0AMDg2NDJ8M1ArK1BzVjltS2pqa28yQm94Z0c2M1ZTKzI0M1U0TzZzRU5pQkVL%0AMjVqOD0%3D%0A"
